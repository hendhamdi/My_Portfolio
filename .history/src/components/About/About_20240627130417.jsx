...
import studentIcon from "../../assets/images/about/studentIcon.png"; // Importez l'image directement
export const About = () => {
  return (
      ...
      <div className={styles.content}>
        ...
        <ul className={styles.aboutItems}>
          <li className={styles.aboutItem}>
                      <img src={getImageUrl("about/studentIcon.png")} alt="Student icon" className={styles.aboutIcon} />
