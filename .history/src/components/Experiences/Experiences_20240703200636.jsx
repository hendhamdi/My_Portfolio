     ...
     <img
      ...
      />
        <div className={styles.content}>
          ...
          <p className={styles.description}>
                <h1 className={styles.stage1}> Stage de Perfectionnement - STAR Siège social ,Tunis </h1><br/>Conception et développement de la partie frontend d’une plateforme en ligne facilitant la
communication entre l’expert et l’assuré, avec un tableau de bord administrateur pour la gestion.
<br/><br/>
                 <h1 className={styles.stage1}>Technologies utilisées :</h1> Html, Css, JS, Firebase.
                </p>
        </div>
