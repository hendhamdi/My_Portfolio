      ...
      />
        <div className={styles.content1}>
          ...
          <p className={styles.description1}>
                <h1 className={styles.stage2}> Stage de Perfectionnement - STAR Siège social ,Tunis </h1>  <img
        src={getImageUrl("experiences/star-logo.png")}
        className={styles.logo1}
      /> <br/>Conception et développement de la partie frontend d’une plateforme en ligne facilitant la
