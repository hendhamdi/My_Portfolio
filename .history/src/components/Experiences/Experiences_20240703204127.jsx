     ...
     <section className={styles.container} id="exp">
        <div className={styles.content}>
          ...
          <p className={styles.description}>
                <h1 className={styles.stage1}> Stage de Fin d’Études - Ooredoo Siège social ,Tunis <img
        src={getImageUrl("experiences/logo-ooredoo.png")}
        className={styles.logo1}
      /> </h1><br/>Conception et développement d’une application mobile pour gérer les réservations des salles de
      ...
      />
        <div className={styles.content1}>
          ...
          <p className={styles.description1}>
                <h1 className={styles.stage2}> Stage de Perfectionnement - STAR Siège social ,Tunis  <img
        src={getImageUrl("experiences/star-logo.png")}
        className={styles.logo1}
      /> </h1> <br/>Conception et développement de la partie frontend d’une plateforme en ligne facilitant la
