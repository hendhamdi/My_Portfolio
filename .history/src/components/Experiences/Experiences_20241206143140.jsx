      ...
      />
        <div className={styles.content1}>
          ...
          <p className={styles.description1}>
                <h1 className={styles.stage2}> Advanced Internship - STAR Headquarters, Tunis</h1> <br/>Designed and developed the frontend of an online platform to facilitate communication between experts and insured individuals, with an admin dashboard for management.
<br/><br/>
